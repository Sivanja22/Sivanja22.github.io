...
<body style="background-image:url(images/location.png)">
	<div class="header">
		<ul>
	...
	<div class="sucontainer" style="background-color:black;width:30%;margin-top:5%;margin-left:30%;">
		<ul style="background-image:url(images/location.png)">			
			<label><b>Search Doctor</b></label>
			<input type="text" name="doctorname" placeholder="Enter Doctor Name"></input>
			<button type="submit" style="position:center;float:right;" name="subd" value="Submit" >Submit</button>
		</ul>
		...
		<div class="container">
			<button type="submit" style="position:center;float:right;" name="submit" value="Submit">Submit</button>
		</div>
<?php
session_start();
if(isset($_POST['subd']))
