...
<center><h1>ADD MANAGER IN A CLINIC</h1><hr>
...
if(isset($_POST['Submit']))
{
		...
		$mid=$_POST['manager'];
				...
				{
							echo "<h2>DATA ADDED successfully( CID=$cid MID=$mid )!!</h2>";
							echo "Please wait.....";
				...
				{
							echo "<h2>DATA ADDED successfully( CID=$cid MID=$mid )in CLINIC TABLE!!</h2>";
							echo "Please wait.....";
							header( "Refresh:2; url=addmanagerclinic.php");
